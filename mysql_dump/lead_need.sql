...
CREATE TABLE `leader` (
  ...
  `fname` char(40) character set cp1251 collate cp1251_bin NOT NULL default '''''',
  ...
  `zip` char(5) character set cp1250 collate cp1250_bin NOT NULL default '''''',
  `email` char(30) character set cp1250 collate cp1250_bin NOT NULL default '''''',
  PRIMARY KEY  (`id`)
...
INSERT INTO `skills` VALUES (19,'.Net'),(18,'Ada'),(2,'AJAX'),(14,'ASP'),(5,'C#'),(4,'C++'),(16,'Cobol'),(3,'CSS'),(21,'Drupal'),(11,'Flash'),(13,'Flex'),(17,'Fortran'),(12,'HTML'),(23,'HTML2'),(6,'Java'),(20,'javaScript'),(10,'jQuery'),(28,'jQuery2'),(15,'Pascal'),(8,'Perl'),(9,'Photoshop'),(1,'PHP'),(7,'Ruby');
...
-- Dump completed on 2009-02-04 19:42:16
